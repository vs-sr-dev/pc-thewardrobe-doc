...
# `--waves` prints one line per file inside a wave, and pc-rpgmakervxace-doc is
# the first object in this collection with a file name outside Latin-1. Without
# this the tool dies of UnicodeEncodeError PART WAY THROUGH the first wave,
# having already printed hundreds of correct rows -- which looks like a
# truncated report rather than a crash, and is the reason this defect was
# scoped at one tool when it is at least ten.
nameguard.guard()
